...
| Surface imagery (depth-shaded oceans) | `includes/images/tex/earth_bathy_{4k,8k,16k}.jpg` | [NASA Blue Marble: Next Generation w/ Topography & Bathymetry](https://visibleearth.nasa.gov/collection/1484/blue-marble) | **Public domain** (NASA) |
| Terrain + sea-floor relief + normal map (displacement & per-pixel detail) | `includes/images/tex/earth_relief_{4k,8k}.jpg`, `earth_normal_{4k,8k}.jpg` (rebuild with `scripts/fetch-relief.py`) | [NOAA NCEI ETOPO Global Relief](https://www.ncei.noaa.gov/products/etopo-global-relief-model) (30 arc-second) | **Public domain** (NOAA) |
